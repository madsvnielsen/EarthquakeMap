    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="absolute -left-4 top-4 z-10 bg-slate-800 border border-slate-700 rounded-r-md p-1 hover:bg-slate-700"
            >
                    ...
                    <ul className="overflow-y-auto flex-1 px-2">
                        {quakes.map((eq) => {
                            ...
                            return (
                                <li
                                    key={eq.id}
                                    onClick={() => onSelectQuake(eq.coords)}
                                    className="flex items-start gap-4 border-b border-white-700 p-3"
                                >
                                    {/* Magnitude Badge */}
                                    <div
                                    ...
                                    <div className="flex flex-col flex-grow text-sm overflow-hidden">
                                        <div className="font-medium text-white line-clamp-2">{eq.title}</div>
                                        <div className="text-xs text-slate-300 mt-1">{eq.place}</div>
                                        <div className="text-xs text-slate-300 mt-1">{date}</div>
                                        <a
                                            href={eq.url}
                                            target="_blank"
                                            rel="noreferrer"
